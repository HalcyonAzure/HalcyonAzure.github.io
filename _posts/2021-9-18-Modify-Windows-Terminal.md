...
3. 在`wt`中打开设置，以下图为例：
   ...
   <img src="https://tc.halc.top/images/2021/09/17/image.png" alt="打开设置.png" style="zoom: 33%;" />

4. 打开JSON设置，以图下为例：

   <img src="https://tc.halc.top/images/2021/09/17/imagef5c36ee5578ac11c.png" alt="打开JSON文件.png" style="zoom: 25%;" />

5. 将刚刚复制的代码粘贴到有`scheme`字样的配置目录下，以下图为例：

   <img src="https://tc.halc.top/images/2021/09/17/imagec63830abf53f7291.png" alt="添加主题.png" style="zoom: 33%;" />

6. 保存后，回到`wt`的设置，选择平时主要使用的窗口界面（e.g.`PowerShell`）然后选择外观，然后选择自己添加的主题，以下图为例：

   <img src="https://tc.halc.top/images/2021/09/17/image99f70b93631ac2a3.png" alt="image99f70b93631ac2a3.png" style="zoom: 25%;" />
